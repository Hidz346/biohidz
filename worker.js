/* Data project HidzProject untuk halaman bio (Cloudflare Workers).
   ...
   CORS), jadi Worker ini yang mengambil halaman tersebut lalu membuka
   datanya. Yang diteruskan ke pengunjung cuma nama dan deskripsi project,
   tidak ada URL atau data lain.

   File statis (public/) dilayani langsung oleh Cloudflare. Worker ini hanya
   dipanggil untuk /api/projects. */
